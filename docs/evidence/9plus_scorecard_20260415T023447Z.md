...
Generated at: 2026-04-15T02:35:05.022354+00:00
...
- `REL-01` PASS (2529 ms): Golden runtime scenarios
...
- `REL-02` PASS (1753 ms): Core runtime state/stream correctness
...
- `ARC-01` PASS (1428 ms): Section 10 integration event/config behavior
...
- `ARC-02` PASS (542 ms): Protocol event model contracts
...
- `CAP-02` PASS (650 ms): P2 security/release capability workflow
...
- `CAP-03` PASS (519 ms): Workspace onboarding flow with provenance/signature gates
...
- `SAFE-01` PASS (703 ms): Runtime policy enforcement tests
...
- `SAFE-02` PASS (2070 ms): Signed run envelope and remote verification
...
- `SAFE-04` PASS (2553 ms): Reference remote worker service allowlist and HTTP roundtrip
...
- `SAFE-03` PASS (517 ms): Workspace onboarding manifest/signature validation
...
- `UX-01` PASS (918 ms): CLI integration flows
...
- `UX-02` PASS (555 ms): TUI slash command behavior
...
- `PERF-01` PASS (1665 ms): Repo/test-matrix cache hit paths
...
- `PERF-02` PASS (594 ms): Security-agent cache hit path
