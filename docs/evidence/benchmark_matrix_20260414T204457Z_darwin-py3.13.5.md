...
Generated at: 2026-04-14T20:45:00.732199+00:00
...
| ID | Description | Passed | Threshold Gate | Duration (ms) | Baseline | Threshold | Max Regression |
|---|---|---|---|---:|---:|---:|---:|
| BM-01 | repo_map cache-hit path | yes | yes | 560 | 650 | 1950 | 200% |
| BM-02 | test_matrix cache-hit discovery path | yes | yes | 562 | 650 | 1950 | 200% |
| BM-03 | security_agent static-scan cache-hit path | yes | yes | 588 | 800 | 2400 | 200% |
| BM-04 | reference remote worker service dispatch path | yes | yes | 1057 | 12000 | 24000 | 100% |
