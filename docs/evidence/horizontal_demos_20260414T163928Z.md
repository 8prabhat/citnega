...
Generated at: 2026-04-14T16:39:30.311873+00:00
Overall pass: yes

| ID | Scenario | Requirement | Passed | Duration (ms) |
|---|---|---|---|---:|
| WF-01 | Code Refactor + Tests + Release Readiness | Code workflow with orchestration and release safety checks | yes | 592 |
| WF-02 | Research/KB Synthesis and Retrieval | Research-style ingestion and retrieval persisted through KB | yes | 761 |
| WF-03 | Ops Diagnosis + Remediation + Verification | Security and release ops workflow with remediation guidance | yes | 608 |
