...
Generated at: 2026-04-15T02:19:46.554574+00:00
...
- `REL-01` PASS (2539 ms): Golden runtime scenarios
...
- `REL-02` PASS (1743 ms): Core runtime state/stream correctness
...
- `ARC-01` PASS (1427 ms): Section 10 integration event/config behavior
...
- `ARC-02` PASS (530 ms): Protocol event model contracts
...
- `CAP-01` PASS (698 ms): Multi-tool orchestration golden flows
...
- `CAP-02` PASS (659 ms): P2 security/release capability workflow
...
- `CAP-03` PASS (552 ms): Workspace onboarding flow with provenance/signature gates
...
- `SAFE-01` PASS (726 ms): Runtime policy enforcement tests
...
- `SAFE-02` PASS (2060 ms): Signed run envelope and remote verification
...
- `SAFE-04` PASS (1556 ms): Reference remote worker service allowlist and HTTP roundtrip
...
- `SAFE-03` PASS (557 ms): Workspace onboarding manifest/signature validation
...
- `UX-01` PASS (919 ms): CLI integration flows
...
- `UX-02` PASS (552 ms): TUI slash command behavior
...
- `PERF-01` PASS (1648 ms): Repo/test-matrix cache hit paths
...
- `PERF-02` PASS (597 ms): Security-agent cache hit path
