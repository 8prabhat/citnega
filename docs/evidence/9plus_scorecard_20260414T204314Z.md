...
Generated at: 2026-04-14T20:43:30.125008+00:00
...
- `REL-01` PASS (2479 ms): Golden runtime scenarios
...
- `REL-02` PASS (1719 ms): Core runtime state/stream correctness
...
- `ARC-01` PASS (1401 ms): Section 10 integration event/config behavior
...
- `ARC-02` PASS (527 ms): Protocol event model contracts
...
- `CAP-01` PASS (695 ms): Multi-tool orchestration golden flows
...
- `CAP-02` PASS (640 ms): P2 security/release capability workflow
...
- `CAP-03` PASS (527 ms): Workspace onboarding flow with provenance/signature gates
...
- `SAFE-02` PASS (1547 ms): Signed run envelope and remote verification
...
- `SAFE-04` PASS (1035 ms): Reference remote worker service allowlist and HTTP roundtrip
...
- `SAFE-03` PASS (528 ms): Workspace onboarding manifest/signature validation
...
- `UX-01` PASS (891 ms): CLI integration flows
...
- `UX-02` PASS (563 ms): TUI slash command behavior
...
- `PERF-01` PASS (1644 ms): Repo/test-matrix cache hit paths
