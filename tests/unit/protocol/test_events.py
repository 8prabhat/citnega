...
class TestBaseEvent:
    def test_auto_event_id(self) -> None:
        ev = TokenEvent(session_id="s1", run_id="r1", token="hello")
...
class TestTokenEvent:
    def test_fields(self) -> None:
        ev = TokenEvent(session_id="s1", run_id="r1", token="hello", is_first=True)
...
class TestApprovalEvents:
    ...
    def test_timeout(self) -> None:
        ev = ApprovalTimeoutEvent(session_id="s1", run_id="r1", approval_id="a1")
